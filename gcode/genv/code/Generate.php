 ...
 * @method static \Genv\code\Gateways\Bar bar(array $config=[]) 条形码
 * @method static \Genv\code\Gateways\Qr qr(array $config=[]) 二维码
 * @package Genv\mailer
 */
define('saveFilePath',dirname(dirname(dirname(dirname(__DIR__)))).DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'Genv'.DIRECTORY_SEPARATOR.'code'.DIRECTORY_SEPARATOR);
